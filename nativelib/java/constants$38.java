...
final class constants$38 {
    ...
    static final MethodHandle _splitpath_s$MH = RuntimeHelper.downcallHandle(
        "_splitpath_s",
        constants$38._splitpath_s$FUNC
    );
